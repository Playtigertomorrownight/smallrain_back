...
public enum WxMenuType {
   ...
   */
  VIEWLIMITED(9,"view_limited"),
  /**
   * miniprogram 小程序类型
   */
  MINIPROGRAM(10,"miniprogram");
  
  private final int code;
  private final String  type;
  
  WxMenuType(int code,String type) {
    this.code = code;
    this.type = type;
  }
